...
- 💡 **LeetCode 500+ problems solved** | 365 Days Badge | Rank 218K
...
### 🔍 [Real-Time Object Detection](https://github.com/anushka072005/Real-Time-Object-Detection)
> Real-time object detection in live video streams using **YOLOv5 + TensorFlow + OpenCV**. Includes custom dataset annotation and model training.

### 🤖 [AI-Powered Resume Screening & Ranking System](https://github.com/anushka072005/AI-powered-Resume-Screening-and-Ranking-System)
> Automated resume parsing and candidate ranking using **NLP + scikit-learn + Streamlit**. Built during AICTE × Microsoft internship.

### 🌾 [NextGen AgriTech Web App](https://github.com/anushka072005/NextGen-AgriTech)
> Smart agriculture web application with responsive UI built using **React + TypeScript + Vite**.

---

## 🏆 Achievements

- 🥇 National Finalist — **IIT Bombay NEC 2024**
- 🏅 **MUJ HackX 2.0** Jaipur, 2024
- 🎓 **SheCodes Scholar '24**
